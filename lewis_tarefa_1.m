% Tarefa 1.0
% 
% Gere o sinal senoidal da linha 12 do ALGORITMO 1 através de uma rotina ???
% (laço de repetição) e altere a frequência para 100Hz. Verifique e analise 
% os resultados nos domínios do tempo e da frequência. Indique os valores 
% analisados nas curvas utilizando os marcadores do Matlab.
% 
...
f = 100;       % frequência do sinal senoidal
...
% fprintf('Valor de n: ', N);

for i = 1:N
    % fprintf('passou no laço \n');
    % disp(i);
    x(i)= sin(2*pi*f*(i-1)/Fs); % construção ponto a ponto
end
